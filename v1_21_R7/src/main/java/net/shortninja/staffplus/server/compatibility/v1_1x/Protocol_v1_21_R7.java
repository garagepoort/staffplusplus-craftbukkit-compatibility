...
import org.bukkit.craftbukkit.v1_21_R7.command.CraftCommandMap;
...
public class Protocol_v1_21_R7 implements IProtocol {
    ...
    private static Channel getChannel(Connection connection) {
        try {
            Field channelField = Connection.class.getDeclaredField("k"); // channel
    ...
    public void inject(Player player) {
        ...
        pipeline.addBefore("packet_handler", "staffplusplus_" + player.getUniqueId(), new PacketHandler_v1_21_R7(player));
    }
