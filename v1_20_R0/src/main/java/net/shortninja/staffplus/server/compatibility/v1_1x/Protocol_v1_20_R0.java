...
public class Protocol_v1_20_R0 implements IProtocol {
    @Override
    ...
    public void inject(Player player) {
        ...
        pipeline.addBefore("packet_handler", "staffplusplus_" + player.getUniqueId(), new PacketHandler_v1_20_R0(player));
    }
