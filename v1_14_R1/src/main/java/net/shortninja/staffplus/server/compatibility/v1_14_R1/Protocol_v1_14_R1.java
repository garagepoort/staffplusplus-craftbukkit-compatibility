...
public class Protocol_v1_14_R1 implements IProtocol {
    ...
    public void inject(Player player) {
        ...
        pipeline.addBefore("packet_handler", "staffplusplus_" + player.getUniqueId().toString(), new PacketHandler_v1_14_R1(player));
    }
