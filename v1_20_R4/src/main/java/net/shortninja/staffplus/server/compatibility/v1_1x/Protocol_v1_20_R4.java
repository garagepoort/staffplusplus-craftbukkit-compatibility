...
public class Protocol_v1_20_R4 implements IProtocol {
    private static final ServerLevel SERVER_LEVEL = ((CraftWorld) Bukkit.getWorlds().get(0)).getHandle();
    ...
    public String getNbtString(org.bukkit.inventory.ItemStack item) {
        ...
        return customData.getUnsafe().getString(NBT_IDENTIFIER);
    }
    ...
    public void sendHoverableJsonMessage(Set<Player> players, String message, String hoverMessage) {
        ...
        ClientboundSystemChatPacket packet = new ClientboundSystemChatPacket(Component.Serializer.fromJson(json.getMessage(), SERVER_LEVEL.registryAccess()), false);
    ...
    public void inject(Player player) {
        ...
        pipeline.addBefore("packet_handler", "staffplusplus_" + player.getUniqueId(), new PacketHandler_v1_20_R4(player));
    }
