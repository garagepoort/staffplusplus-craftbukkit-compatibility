...
public class Protocol_v26_2_R0 implements IProtocol {
    ...
    public void inject(Player player) {
        ...
        pipeline.addBefore("packet_handler", "staffplusplus_" + player.getUniqueId(), new PacketHandler_v26_2_R0(player));
    }
