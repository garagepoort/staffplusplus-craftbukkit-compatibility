...
public class Protocol_v1_20_R2 implements IProtocol {
    @Override
    ...
    private static Connection getConnection(Player player) {
        try {
            ...
            Field connectionField = ServerGamePacketListenerImpl.class.getSuperclass().getDeclaredField("c"); // connection
    ...
    public void inject(Player player) {
        ...
        pipeline.addBefore("packet_handler", "staffplusplus_" + player.getUniqueId(), new PacketHandler_v1_20_R2(player));
    }
