...
public class Protocol_v1_21_R3 implements IProtocol {
    ...
    public void inject(Player player) {
        ...
        pipeline.addBefore("packet_handler", "staffplusplus_" + player.getUniqueId(), new PacketHandler_v1_21_R3(player));
    }
